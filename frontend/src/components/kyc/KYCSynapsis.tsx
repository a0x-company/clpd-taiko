...
const KYCSynapsis = ({ sessionId, setStatusKyc, statusKyc }: KYCSynapsisProps) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
        ...
        onFinish: () => {
          fetch(`/api/kyc?sessionId=${sessionId}`, {
            ...
            .then((data) => {
              ...
              const redirectStatus = data?.sessionDetails.session.status || "UNKNOWN";
              console.log(redirectStatus);

              if (redirectStatus === "VERIFIED" || redirectStatus === "APPROVED") {
                toast({
    ...
    <section className="bg-zinc-100 flex flex-col items-center justify-center">
      <Card className="w-full max-w-4xl text-black bg-white rounded-t-none">
        <CardHeader>
          ...
          <CardDescription>
            Por favor, proporcione la siguiente información para completar la configuración de su
            cuenta.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="grid grid-cols-2 gap-6">
              ...
              <div>
                <label htmlFor="isCompany" className="block text-sm font-medium text-gray-700">
                  ¿Es una empresa?
                </label>
                <input
                  type="checkbox"
              ...
              <div>
                ...
                {errors.document?.documentNumber && (
                  <p className="text-red-500 text-sm">{errors.document.documentNumber.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.document?.documentType && (
                  <p className="text-red-500 text-sm">{errors.document.documentType.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.document?.country && (
                  <p className="text-red-500 text-sm">{errors.document.country.message}</p>
                )}
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                {errors.address?.addressCity && (
                  <p className="text-red-500 text-sm">{errors.address.addressCity.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.address?.addressStreet && (
                  <p className="text-red-500 text-sm">{errors.address.addressStreet.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.address?.addressZipCode && (
                  <p className="text-red-500 text-sm">{errors.address.addressZipCode.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.address?.addressCountry && (
                  <p className="text-red-500 text-sm">{errors.address.addressCountry.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.address?.addressState && (
                  <p className="text-red-500 text-sm">{errors.address.addressState.message}</p>
                )}
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                {errors.personalInfo?.names && (
                  <p className="text-red-500 text-sm">{errors.personalInfo.names.message}</p>
                )}
              </div>

              <div>
                <label htmlFor="firstLastname" className="block text-sm font-medium text-gray-700">
                  Primer apellido:
                </label>
                <input
                  type="text"
                  ...
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      className={cn(
                        ...
                        !getValues("personalInfo.dob") && "text-muted-foreground"
                      )}
                    >
              ...
              <div>
                ...
                {errors.personalInfo?.activity && (
                  <p className="text-red-500 text-sm">{errors.personalInfo.activity.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.personalInfo?.dob && (
                  <p className="text-red-500 text-sm">{errors.personalInfo.dob.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.personalInfo?.nationality && (
                  <p className="text-red-500 text-sm">{errors.personalInfo.nationality.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.personalInfo?.gender && (
                  <p className="text-red-500 text-sm">{errors.personalInfo.gender.message}</p>
                )}
              </div>
            </div>
